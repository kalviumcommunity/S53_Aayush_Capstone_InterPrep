...
const interviewerSchema = new mongoose_1.Schema({
    ...
    dateJoined: {
        type: String,
        default: formatDate_1.default // Use the formatDate utility function for date format
    }
});
// Create and export the model
const Interviewer = mongoose_1.default.model("Interviewer", interviewerSchema);
